...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        nargs='?',
        help="Directory that contains images/ and results/, i.e."
        "the directory you untared human_eva_images_and_results.tar.gz")
    parser.add_argument(
        '-seq',
        default='S1_Walking',
        nargs='?',
    ...
    all_frames = sorted([fr for fr in glob(join(img_dir, '*.png'))])
